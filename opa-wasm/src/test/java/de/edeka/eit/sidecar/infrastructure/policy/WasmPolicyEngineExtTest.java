package de.edeka.eit.sidecar.infrastructure.policy;
...
class WasmPolicyEngineExtTest {
    ...
    private void setWasmBundle(WasmPolicyEngine engine, byte[] bytes, long version) throws Exception {
        Class<?> bundleClass = Class.forName("de.edeka.eit.sidecar.infrastructure.policy.WasmPolicyEngine$PolicyBundle");
