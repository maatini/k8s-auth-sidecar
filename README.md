...
│                                                                     │
│  ┌──────────────────────────────┐    ┌───────────────────────────┐ │
│  │      RR-SIDECAR (8080)       │───▶│   MAIN APPLICATION (8081) │ │
│  │  ┌────────────────────────┐  │    │                           │ │
│  │  │  1. Token Validation   │  │    │   Receives only           │ │
│  │  │  2. Roles Enrichment   │  │    │   authenticated &         │ │
│  │  │  3. Policy Evaluation  │  │    │   authorized requests     │ │
